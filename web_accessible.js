    ...
    if (window.platform) {
      try {
        ...
        if (window.platform.general?.productCatalogLink) {
          console.info('DanDomain Storefront Editor: Found catalog link from platform:', window.platform.general.productCatalogLink);
        ...
        if (window.platform.page) {
          ...
          console.info('DanDomain Storefront Editor: Page analysis:', {
            isProduct: data.isProductPage,
            productId: window.platform.page.productId,
            categoryId: data.categoryId,
            isText: window.platform.page.isText,
            isFrontPage: window.platform.page.isFrontPage,
